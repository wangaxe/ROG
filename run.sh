...
# python dat_main.py --task 3 --gpu 0 --batch 2 --name DEAT_out --AT
...
# python dat_main.py --task 7 --gpu 0 --batch 3 --name DEAT_out --AT

# python dat_main.py --task 8 --gpu 0 --batch 5 --name DEAT_out --AT
